...
$(document).ready(
    function(){
        ...
        // 이유는 javascript로 동적으로 생성한 element는 javascript에서 해당 요소의 이벤트를 감지 못함
        // 왜냐하면 javascript보다 나중에 생성된 element이기 때문이다.
        // html5는 이벤트 버블링이 있어서 모든 이벤트는 부모로 전파된다는 속성을 이용해서
        // 역으로 해당 부모가 이벤트를 감지해서 발생하면 자식의 부모 엘리먼트를 제거할 수 있다.
        // 이것이 바로 이벤트 위임
        // 테이블, 리스트, 댓글
